...
# Scrapy settings for albawabhnews project
#
...
BOT_NAME = 'albawabhnews'

SPIDER_MODULES = ['albawabhnews.spiders']
NEWSPIDER_MODULE = 'albawabhnews.spiders'


# Crawl responsibly by identifying yourself (and your website) on the user-agent
#USER_AGENT = 'albawabhnews (+http://www.yourdomain.com)'
...
#SPIDER_MIDDLEWARES = {
#    'albawabhnews.middlewares.AlbawabhnewsSpiderMiddleware': 543,
#}
...
ITEM_PIPELINES = {
   'albawabhnews.pipelines.AlbawabhnewsPipeline': 300,
   'albawabhnews.pipelines.JsonWritePipline': 300,
   #'alnaharegypt.pipelines.WebcrawlerScrapyPipeline': 300,#保存到mysql数据库
   'albawabhnews.pipelines.MongoPipeline': 300,
}
