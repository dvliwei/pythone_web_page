...
DOWNLOADER_MIDDLEWARES = {
   'alnaharegypt.middlewares.AlnaharegyptDownloaderMiddleware': None,
   'alnaharegypt.middlewares.MyUserAgentMiddleware': 400,
   #'alnaharegypt.middlewares.proxMiddleware': 401,
}
